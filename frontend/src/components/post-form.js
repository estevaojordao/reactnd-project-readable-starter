      ...
      <div>
        <form className="ui form">
          ...
          <div className="ui actions">
            <button type="cancel" className="red ui button labeled icon" onClick={this.handleCancel}><i
              className="icon undo"/>Cancel
            </button>
            <button type="submit" className="green ui button labeled icon" onClick={this.handleSubmit}><i
              className="icon save outline"/>Submit
            </button>
          </div>
        </form>
      </div>
